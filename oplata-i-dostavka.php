...
<p>Оплата происходит через авторизационный сервер Процессингового центра Банка с использованием Банковских кредитных карт
      ...
      <p>При выборе формы оплаты с помощью пластиковой карты проведение платежа по заказу производится непосредственно после его
        ...
        карты Вы сможете повторить процедуру оплаты.</p>
                                        ...
                                        При оформлении заказа онлайн оплата происходит через систему <abbr title="Robokassa">Robokassa</abbr>. Мы также можем выставить счет на онлайн-оплату <abbr title="PayPal">PayPal</abbr> или <abbr title="Яндекс.Деньги">Яндекс.Деньги</abbr> при заказе через <a href="//<?php echo $_SERVER['SERVER_NAME'];?>/contact.php">электронную почту</a> или в <a href="//<?php echo $_SERVER['SERVER_NAME'];?>/contact.php">нашем офисе</a>.
                                        
                                        

<h4>Наличная оплата</h4>
Вы можете оплатить заказ наличными в <a href="//<?php echo $_SERVER['SERVER_NAME'];?>/contact.php">нашем офисе</a>.

<h4>Безналичная оплата</h4>
Оплатить заказ можно через любой банк, который принимает платежи от физических лиц, в том числе через Интернет-банк. Счет можно скачать при заказе онлайн, получить по электронной почте или в бумажном виде в <a href="//<?php echo $_SERVER['SERVER_NAME'];?>/contact.php">нашем офисе</a>. 
...
<a href="//<?php echo $_SERVER['SERVER_NAME'];?>/contact.php#sklad" class="more-link">Схема проезда <span class="meta-nav">→</span></a>
