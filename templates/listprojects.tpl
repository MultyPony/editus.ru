...
<?php if (count($data) > 0) { ?>
    <table id="listprojects" class="dataview" style="width: 100%;">
        <thead>
            <tr>
                <th><?php echo _LP_PROJECTNUMBER; ?></th>
                <th><?php echo _LP_PROJECTNAME; ?></th>
                <th><?php echo _LP_PROJECTCOUNT; ?></th>
                <th><?php echo _LP_PROJECTTOTAL; ?></th>
                <th><?php echo _LP_PROJECTREG; ?></th>
                <th><?php echo _LP_PROJECTDEL; ?></th>
            </tr>
        </thead>
        <tbody align="center">
            <?php
            foreach ($data as $cur) {
            ?><tr>
                    <td><?php echo $cur[0]; ?></td>
                    <td><?php echo _LP_PROJECTSUFF . $cur[0]; ?></td>
                    <td class="editcount" id="<?php echo $cur[0]; ?>"><?php echo $cur[1]; ?></td>
                    <td id="<?php echo $cur[0]; ?>res"><?php echo ceil($cur[2]); ?> <?php echo _LP_RUB; ?></td>
                    <td>
