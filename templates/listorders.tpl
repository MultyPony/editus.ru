...
<?php if (count($orders) > 0) { ?>
    <table id="listorders" class="dataview" style="width: 100%;">
        <thead>
            <tr>
                <th><?php echo _LO_ORDERNUMBER; ?></th>
                <th><?php echo _LO_ORDERNAME; ?></th>
                <th><?php echo _LO_ORDERAUTOR; ?></th>
                <th><?php echo _LO_ORDERCOUNT; ?></th>
                <th><?php echo _LO_ORDERDATE; ?></th>
                <th><?php echo _LO_ORDERSTATUS; ?></th>
                <th><?php echo _LO_ORDERDEL; ?></th>
            </tr>
        </thead>
        <tbody align="center">
            <?php
            foreach ($orders as $cur) { ?>
                <tr>
                    ...
                    <td><?php echo $cur['orderName']; ?></td>
                    <td><?php echo $cur['orderAutor']; ?></td>
                    <td><?php echo $cur['orderCount']; ?></td>
...
<?php } ?>
<hr>
<a href="editus.php?do=orderstep1" class="button red">Новый заказ</a>
