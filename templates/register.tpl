    ...
    <?php if (!isset($send)) { ?>
        <form method="post" action="<?php echo $action[2]; ?>"  id="register_form">
            <div>
                ...
                <p><label>Регистрируясь, я принимаю условия <a href="//<?php echo $_SERVER['SERVER_NAME'];?>/new/terms.html">Пользовательского соглашения</a> и даю согласие на обработку своих персональных данных в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных».</label></p>
            </p>
        </form>
</div>
    <hr />
