<fieldset id="os4" style="min-height: 280px;">
    ...
    <div id="avangard-visa-mastercard" style="text-align: center; display: none;" class="meth">
        <?php
            echo '<a target="_blank" href="bill/cardpay/redirect.php?o=' . $_GET['o'] . '&type=pub" >Перейти к оплате</a>';
        ?>
    </div>
<div style="text-align: center; margin-top: 50px;">
<a href="new/credit.html" class="head" target="_blank"><span>или узнайте как напечатать книгу в кредит &rarr;</span></a>
