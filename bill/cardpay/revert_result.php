...
$data['order_amount'] = ($data['order_amount'] * 100);
        ...
        if ($res['response_code'] == 0){
            ...
            switch ($res['status_code']) {
                case 1:
                    ...
                    header("Location: https://editus-dev.ru/editus.php?do=orderstep4&o=" . $orderId . '&paycard_status=1');
                    exit;
                case 3:
                    $db = new Db();
                    ...
                    header("Location: https://editus-dev.ru/editus.php?do=listorders&o=" . $orderId);
                    exit;
                    break;
                case 2:
                    $CardPay->setStatusCode($originOrderId, 2);
                    header("Location: https://editus-dev.ru/editus.php?do=orderstep4&o=" . $orderId . '&paycard_status=99');
                    exit;
                    break;
                default:
                    header("Location: https://editus-dev.ru/editus.php?do=orderstep4&o=" . $orderId . '&paycard_status=99');
    ...
    if ($type=='sho'){
        ...
        if ($res['response_code'] == 0){
            ...
            switch ($res['status_code']) {
                case 1:
                    $CardPay->updateStatus($originOrderId, 5);
                    header("Location: https://editus-dev.ru/editus.php?do=shoporderstep2&o=" . $orderId . '&paycard_status=1');
                    exit;
                case 3:
                    $db = new Db();
                    ...
                    header("Location: https://editus-dev.ru/editus.php?do=shoporderstep2&o=" . $orderId . '&paycard_status=0');
                    exit;
                    break;
                case 2:
                    $CardPay->removeRegInfo($originOrderId);
                    header("Location: https://editus-dev.ru/editus.php?do=shoporderstep2&o=" . $orderId . '&paycard_status=99');
                    exit;
                    break;
                default:
                    header("Location: https://editus-dev.ru/editus.php?do=shoporderstep2&o=" . $orderId . '&paycard_status=99');
    ...
    header("Location: https://editus-dev.ru/");
}