...
if ($_GET['type'] == 'pub'){
    ...
    $data['back_url'] = "https://editus-dev.herokuapp.com/bill/cardpay/revert_result.php";
    Log::save($data);
...
if ($_GET['type'] == 'sho'){
    ...
    header("Location: https://editus-dev.herokuapp.com/editus.php?do=shoporderstep2&o=" . intval($_GET['o']) . '&paycard_status=99');
    exit(0);
}
