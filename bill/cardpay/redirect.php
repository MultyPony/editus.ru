...
if ($_GET['type'] == 'pub'){
    ...
    $data['back_url'] = "https://editus.ru/bill/cardpay/revert_result.php";
    Log::save($data);
    ...
    header("Location: https://editus.ru/editus.php?do=orderstep4&o=" . intval($_GET['o']) . '&paycard_status=99');
    exit(0);
}
...
if ($_GET['type'] == 'sho'){
    ...
    header("Location: https://editus.ru/editus.php?do=shoporderstep2&o=" . intval($_GET['o']) . '&paycard_status=99');
    exit(0);
}
