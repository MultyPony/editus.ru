...
function orderstep1(&$e, &$t)
{
    if (!isset($_GET['a'])) {
        ...
        $tpl->set_vars(array(
            ...
            //     'ftemplate' => $ftemplate,
            //     'addedads' => $addedads,
            //     'hrefblock' => $href['tbbHref'],
            //     'hrefcover' => $hrefcover,
            'author' => $author[0] . ' ' . $author[1],
            //     'action' => Main_config::$main_file_name . '?do=orderstep2&amp;o=' . intval($_GET['o']),
...
{
    if (isset($_POST['book-name']) && isset($_POST['book-author']) &&
...
function orderstep3(&$e, &$t, &$u)
{
    ...
    if (isset($_POST['colorblock']) && isset($_POST['paperblock']) &&
        ...
        $tpl = new Template();
        $tpl->set_path('templates/');
        $tpl->set_vars(array('orderid' => $_POST['orderid']));
        $tpl->fetch('orderstep3.tpl');
        return $tpl->get_tpl();
    }
    // if (!isset($_GET['a'])) {
