...
function supportadmin(&$e) {
    ...
    $data['sc_cat']=$_POST['sc_cat'];
     if (isset($_POST['sc_message'])){
       ...
       $t = $db->fetch_array();
       $e->mail($t[0], 'Новое сообщение', 'Вы получили ответ на Ваше сообщение в службу техподдержки. Для прочтения перейдите по ссылке - //editus.ru/editus.php?do=viewsupportmess&id='.intval($_POST['replyId']));
    }
    $datamess = array();
