 ...
 * @package jquery-sparkle {@link //www.balupton/projects/jquery-sparkle}
 * @author Benjamin "balupton" Lupton {@link //www.balupton.com}
 * @copyright (c) 2009-2010 Benjamin Arthur Lupton {@link //www.balupton.com}
 * @license GNU Affero General Public License version 3 {@link //www.gnu.org/licenses/agpl-3.0.html}
 */
...
// inspired by James Padolsey's snippet (//remysharp.com/2009/01/26/element-in-view-event-plugin/#comment-127058)
$.extend( $.expr[':'], {
	...
	var $window = $( window ),
		...
		init = function( settings, callback ) {
			...
			_initMasonry( function() {
				...
				// where the image is
				// example: //www.sitename.com/gamma/?img=12
		...
		_singleviewitem = function( $item, anim ) {
			...
			setTimeout( function() {
				...
				_applyAnimation( Gamma.overlay, { 'opacity' : 1 }, Gamma.settings.speed, Gamma.supportTransitions || !anim, function() {
					...
					// //stackoverflow.com/a/3485654/989439
