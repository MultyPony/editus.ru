...
<?php } else { ?>   
    ...
    ?>
    <a href="editus.php?do=showcart"> купить книгу<span <?php  echo $s;?> id="cart"> (<span id="carts"><?php  echo $row['amount'];?></span>)</span></a>, 
    <a href="editus.php?do=editclientdata"> мои данные</a>,
    <a href="editus.php?do=logout">выход</a><?php }
