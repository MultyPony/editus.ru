...
header('Location: //editus-dev.herokuapp.com/new/pdf.html'.$ref); 
exit(); 
?>
<?php session_start(); ?>
...
<div id="left">
<div id="relative">
<a href="//editus-dev.herokuapp.com"><img src="img/logo.gif" width="250" height="328" alt="Editus" border="0"></a>
